...
//	[Designer(typeof(PanelDesigner)),DesignTimeVisibleAttribute(true)]
	...
	[System.Drawing.ToolboxBitmapAttribute(typeof(RichTextBox))]
	public class RichTextPanel : UserControl, IDataValue
	{
		...
		public string InputValue { get { return this.RTF.Text; } set { this.RTF.Text = value; } }
...
//		{
//			ComponentContent cc = new ComponentContent(this);
//			cc.Name = GetType().Name;
//			cc.Value =
		////			throw new NotImplementedException();
//		}
//
//		public string FromContent(ComponentContent content)
//		{
//			throw new NotImplementedException();
//		}
		...
		class LabelNfo : DbActionList
		{
			...
			RichTextPanel rtf { get { return Component as RichTextPanel; } }
			public string LabelText { get { return rtf.label.Text; } set { rtf.label.Text = value; } }
		}
		class Mondo : DbActionList
		{
			RichTextPanel rtf { get { return Component as RichTextPanel; } }
			virtual public Font RtfFont { get { return rtf.RTF.Font; } set { rtf.RTF.Font = value; } }
			[TypeConverterAttribute(typeof(MultilineStringConverter))]
			virtual public string Text { get { return rtf.RTF.Text; } set { rtf.RTF.Text = value; } }
