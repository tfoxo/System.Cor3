...
namespace System.Cor3.Forms.rtf
{
	...
	public class MarginRenderer : BufferedRenderer
	{
		...
		FloatPoint MousePoint { get { return Client.PointToClient(Control.MousePosition); } }
		...
		FloatPoint C { get { return Client.ClientSize; } }
		...
		public GraphicsPath MarginsPath
		{
			get {
				...
				FloatPoint ml1 = new FloatPoint(RtfInfo.SelectionIndent,y1);
				FloatPoint ml2 = new FloatPoint(RtfInfo.SelectionIndent,y2);
				FloatPoint mc1 = new FloatPoint(RtfInfo.SelectionRightIndent,y1);
				FloatPoint mc2 = new FloatPoint(RtfInfo.SelectionRightIndent,y2);
				FloatPoint mh1 = new FloatPoint(RtfInfo.SelectionHang,y1);
				FloatPoint mh2 = new FloatPoint(RtfInfo.SelectionHang,y2);
