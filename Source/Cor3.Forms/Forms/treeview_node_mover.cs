...
namespace System.Cor3.Forms
{
	...
	public delegate void TreeNodeDelete(TreeView parent_tree, TreeNode selected, bool cancel);
	public delegate void Context(treeview_node_mover mover, ContextMenuStrip strip);
	public class treeview_node_mover : object_manager<TreeView>
	{
		public event TreeNodeDelete NodeDeleting;
		public event TreeNodeDelete NodeDropped;
		public event Context CreatedContext;

		protected virtual void OnCreatedContext(ContextMenuStrip strip) { if (CreatedContext != null) CreatedContext(this,strip); }
		protected virtual void OnNodeDropped(TreeView parent_tree, TreeNode selected, bool cancel) { if (NodeDropped != null) NodeDropped(parent_tree, selected, cancel); }
		protected virtual void OnNodeDeleting(TreeView parent_tree, TreeNode selected, bool cancel) { if (NodeDeleting != null) NodeDeleting(parent_tree, selected, cancel); }
		...
		{
			bool bdel = false; OnNodeDeleting(this.Client,Client.SelectedNode,bdel);
