...
namespace System.Cor3.Forms
{
	...
	/// <summary>
	/// A toolstrip designed to abstract, automate and/or simplify a layer of
	/// graphics methods.  This doesn't seem to have happened, and I seem
	/// to have lost interest in the class all-together.
	/// </summary>
	public class ToolStripExtender : ToolStrip
	{
		LinearGradientBrush BackgroundGradient { get { return Gradients.GetLinearGradient(FloatPoint.Empty,new FloatPoint(0,this.ClientSize.Height),SystemColors.MenuBar,SystemColors.Window); } }
