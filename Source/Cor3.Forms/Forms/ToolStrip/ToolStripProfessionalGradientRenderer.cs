...
{
	public class ToolStripProfessionalGradientRenderer : ToolStripProfessionalRenderer
	{
		ToolStripGradientControl _control;
		ToolStripProfessionalRenderer _tssr = new ToolStripProfessionalRenderer();
		...
		public ToolStripProfessionalGradientRenderer() : base()
		{
