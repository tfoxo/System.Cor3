...
#define MyAppName "Feed Tool"
#include "setup-feed-tool-v1.inc"
#define MyAppPublisher "tfwroble@gmail.com"
#define MyAppExeName "FeedTool.exe"

#define FeedBinPath "F:\DEV\WIN\CS_ROOT\Projects\System.Cor3\Source-Tools\FeedTool"
...
AppId={{ABB6A488-14FC-4FF5-8205-66632440E706}
AppName={#MyAppName}
...
Source: "{#FeedBinPath}\Build\Bin\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
