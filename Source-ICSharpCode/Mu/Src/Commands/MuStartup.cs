						...
						ICSharpCode.SharpDevelop.Gui.WorkbenchSingleton.MainWindow.Dispatcher.Invoke
							(DispatcherPriority.Normal, new System.Threading.ThreadStart
							 (
							 	delegate
							 	{
//							 		MessageBox.Show("Attempted to initialize!\n\n" +
//							 		                "Note that this message is only for testing and shows that we succeeded in initializing the plugin and accessing load-time!");
