...
namespace ThemeTool
{
	...
	public class ThemeToolCommandDev11a : AbstractMenuCommand
	{
		public override void Run()
		{
			var settings = new ToolSettings();
			settings.SetTheme("dev2o11");
			settings.SaveSettings("dev2o11");
		}
	}
	public class ThemeToolCommandDev11b : AbstractMenuCommand
	{
		public override void Run()
		{
			var settings = new ToolSettings();
			settings.SetTheme("dev2o11v2");
			settings.SaveSettings("dev2o11v2");
		}
	}
